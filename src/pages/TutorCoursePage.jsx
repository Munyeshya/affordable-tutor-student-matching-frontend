  ...
  return (
    <section className="course-workspace-panel">
      ...
      <form className="course-details-form" onSubmit={onSubmit}>
        ...
        <label><span>Course price (RWF)</span><input required disabled={!editable} type="number" min="0.01" step="any" value={form.price} onChange={(event) => onChange('price', event.target.value)} /><small>Enter any positive total price. A course cannot be submitted or published without it.</small></label>
