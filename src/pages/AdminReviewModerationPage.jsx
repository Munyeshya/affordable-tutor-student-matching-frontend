  ...
  return (
    <section className="admin-review-page">
      ...
      <form className="admin-review-filters" onSubmit={applyFilters}>
        ...
        <label><span>Review type</span><select value={draftFilters.review_type} onChange={(event) => updateDraft('review_type', event.target.value)}><option value="">All types</option><option value="BOOKING">Tutoring sessions</option><option value="COURSE">Courses</option><option value="LESSON">Legacy lesson reviews</option></select></label>
